...
class ListaEfeitosSecundariosFragment : Fragment(), LoaderManager.LoaderCallbacks<Cursor> {

    private var _binding: FragmentListaEfeitosSecundariosBinding? = null
    private var adapterEfeitosSecundarios : AdapterEfeitosSecundarios? = null
    ...
    override fun onCreateLoader(id: Int, args: Bundle?): Loader<Cursor> {
        return CursorLoader(
            ...
            null, null,
            TabelaEfeitosSecundarios.CAMPO_ID_VACINA
        )
    }
    ...
    override fun onLoadFinished(loader: Loader<Cursor>, data: Cursor?) {
        adapterEfeitosSecundarios!!.cursor = data
    }
    ...
    override fun onLoaderReset(loader: Loader<Cursor>) {
        adapterEfeitosSecundarios!!.cursor = null
    }

    companion object {
        const val ID_LOADER_MANAGER_EFEITOS_SECUNDARIOS = 0
    }
}
...
data class Vacina (var id: Long = -1, var num_lote: String, var data_vacinacao: Long, var idPaciente: Long, var idFabricante: Long) {
    fun toContentValues(): ContentValues {
        val valores = ContentValues().apply {
            put(TabelaVacina.NUM_LOTE, num_lote)
            put(TabelaVacina.DATA_VACINACAO, data_vacinacao)
